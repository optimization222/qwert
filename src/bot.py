...
# ===== КОНФИГ =====
BOT_TOKEN = "8827803928:AAHxL8VCxqPmIECZvl2zbC4GPnZb9KSlJ8g"
GROUP_ID = -1001234567890  # ID твоей группы
...
# ===== МАТ-СЛОВА (ТОЛЬКО ЛЮДСКИЕ ОСКОРБЛЕНИЯ) =====
BAD_WORDS = [
...
def keep_alive():
    url = "https://nexbot-thp4.onrender.com"
    while True:
        try:
            requests.get(url)
        except:
